...
const transferSuccessfulReceiverTemp = (r_fName, amount, ticker, sender, t_id) => {
                    ...
                    <table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                      <tr>
                        <td class="pad" style="padding-bottom:20px;padding-top:10px;text-align:center;width:100%;">
                          <h2 style="margin: 0; color: #148674; direction: ltr; font-family: Inter, sans-serif; font-size: 15px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Dear ${r_fName},&nbsp;</span></h2>
                        </td>
                      </tr>
                    </table>
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              This is to notify you of a successful asset transfer made to your account by you to another ${process.env.APP_NAME} user some moments ago. The transfer transaction has the following details:
                            </p>
                            <p style="margin: 0; margin-bottom: 0px;">&nbsp;</p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:16px">
                              Amount: <b>${amount} ${ticker}</b>
                            </p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:16px">
                              Transferred from: <b>${sender}</b>
                            </p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:16px">
                              Transaction ID: <b>${t_id}</b>
                            </p>
                          </div>
                        </td>
                      </tr>
                    ...
                    <table class="paragraph_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                      <tr>
                        <td class="pad" style="padding-top:10px;">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0;">If you have any questions regarding this transaction, kindly rerach out to our support team. Welcome to ${process.env.APP_NAME} once again.</p>
                          </div>
                        </td>
                      </tr>
                    </table>
