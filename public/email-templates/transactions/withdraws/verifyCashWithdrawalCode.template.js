...
const verifyCashWithdrawalCodeTemp = (fName, otp, amount, ticker, destination) => {
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              It seems you are trying to withdraw some cash from your account on ${process.env.APP_NAME} a bank account found on your profile. You are attempting to withdraw a sum of <b>${ticker} ${amount}</b> to a bank named <b>${destination.bankName}</b> with an account name <b>${destination.accountName}</b> with an account number <b>${destination.accountNumber}</b>.
                              To validate the transaction, please use the 4-digit code below
                            </p>
                    ...
                    <table class="paragraph_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                      <tr>
                        <td class="pad" style="padding-top:10px;">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0;">The verification code will be valid for 1 hour. Please do not share this code with anyone. Contact us if you do not recognize this activity. Welcome to ${process.env.APP_NAME} once again.</p>
                          </div>
                        </td>
                      </tr>
                    </table>
