...
const cashWithdrawalSuccessfulTemp = (fName, amount, ticker, destination, t_id) => {
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              This is to notify you of a successful cash withdrawal transaction that was done by you on ${process.env.APP_NAME} some moments ago. The transaction attempt was verified with a one-time password sent to your account email. Details of the transaction below:
                            </p>
                            <p style="margin: 0; margin-bottom: 0px;">&nbsp;</p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:13px">
                              Amount: <b>${ticker} ${amount}</b>
                            </p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:13px">
                              Bank Name: <b>${destination.bankName}</b>
                            </p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:13px">
                              Account Name: <b>${destination.accountName}</b>
                            </p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:13px">
                              Account Number: <b>${destination.accountNumber}</b>
                            </p>
                            <p style="margin: 0; margin-bottom: 0px; font-size:14px">
                    ...
                    <table class="paragraph_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                      <tr>
                        <td class="pad" style="padding-top:10px;">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0;">If you did not sanction this transaction move, be sure to get in touch with our customer support team. Welcome to ${process.env.APP_NAME} once again.</p>
                          </div>
                        </td>
                      </tr>
                    </table>
