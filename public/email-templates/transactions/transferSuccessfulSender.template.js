...
const transferSuccessfulSenderTemp = (fName, amount, ticker, username) => {
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              This is to notify you of a successful asset transfer transaction that was done by you to another ${process.env.APP_NAME} user some moments ago. The transfer attempt was verified with a one-time password sent to your account email. Details of the transaction below:
                            </p>
