...
const cashDepositCreatedTemp = (fName, formattedAmount, t_id) => {
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              Your attempt to deposit a sum of <b>${formattedAmount}</b> to your account on ${process.env.APP_NAME} has been received and being processed. Ensure you made the deposit to the account details generated for you during the transaction process. The transaction will be completed within a few seconds. Details below
                            </p>
