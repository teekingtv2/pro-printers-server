...
const verifyTransferCodeTemp = (fName, otp, amount, ticker, username) => {
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              It seems you are trying to transfer some assets from your account to another user on our platform, ${process.env.APP_NAME}. You are attempting to transfer a sum of ${amount} ${ticker} to user ${username}.
