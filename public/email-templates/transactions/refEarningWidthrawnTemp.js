...
const refEarningWidthrawnTemp = (fName, formattedAmount) => {
                        ...
                        <td class="pad">
                          <div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                            <p style="margin: 0; margin-bottom: 0px;">
                              This is to inform you that your attempt to withdraw your referral earning has successfully completed. The withdrawn amount has been added to your fiat balance on your ${process.env.APP_NAME} account. The withdrawn amount is <b>${formattedAmount}</b>
                            </p>
